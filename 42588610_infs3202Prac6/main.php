	...
	<head>
        ...
        <script>
            ...
            function showLocation(dealid) {
                ...
                xmlhttp.open("GET","getposition.php?d="+dealid,true);
                xmlhttp.send();
            }
            
            function getDirections(idOfMarker) {
                if (marker == undefined) {
                    return;
                }
                if (marker.id != idOfMarker) {
                    return;
                }
                if (directionsDisplay != undefined) {
                    directionsDisplay.setMap(null);
			...
			<table>
                <?php
                    ...
                    for ($i = 1; $i <= $numrows; $i++) {
                        ...
                        echo "<td><input type='button' id='showlocation$id' value='Show Location' onclick='showLocation($id)'/></td>";
                        echo "<td><input type='button' id='directions$id' value='Get Directions' onclick='getDirections($id)'/></td>";
                        echo "</tr>";
